...
MPV_CONF_OPTS += -Dbuild-date=enabled
else
...
MPV_CONF_OPTS += -Degl-drm=false
endif
else
MPV_CONF_OPTS += -Dgbm=false -Degl-drm=false
endif
...
MPV_CONF_OPTS += -D-wayland=enabled
